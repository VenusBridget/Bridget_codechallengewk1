...
window.alert('Gross Salary: ' + grossSalary)
window.alert('PAYE: ' + taxRates(grossSalary))
window.alert('NHIF Deductions: ' + nhifDeductions(grossSalary))
window.alert('NSSF Deductions: ' + nssfDeductions(grossSalary))